...
from wishlist.views import  create_ajax_wishlist,show_wishlist_ajax,filtered_json_return , filtered_xml_return, show_wishlist, xml_return, json_return, register, login_user, logout_user
